...
const renderReviewedHeadHilt = ({ hilt, dark, accent }: ReviewedHeadSpriteConfig) => (
  <>
    <rect x="8" y="15" width="8" height="2" fill={hilt}/>
    <rect x="10" y="17" width="4" height="4" fill={dark}/>
    <rect x="11" y="18" width="2" height="2" fill={hilt}/>
    <rect x="9" y="16" width="6" height="1" fill={accent}/>
  </>
);

const renderReviewedHeadMotif = (config: ReviewedHeadSpriteConfig) => {
  ...
  switch (config.motif) {
    ...
    case 'gear':
      return (
        <>
          <rect x="8" y="5" width="8" height="8" fill={dark}/>
          <rect x="10" y="3" width="4" height="2" fill={metal}/>
          <rect x="10" y="13" width="4" height="2" fill={metal}/>
          <rect x="6" y="7" width="2" height="4" fill={metal}/>
          <rect x="16" y="7" width="2" height="4" fill={metal}/>
          <rect x="9" y="6" width="6" height="6" fill={metal}/>
          <rect x="10" y="7" width="4" height="4" fill={edge}/>
          <rect x="11" y="8" width="2" height="2" fill="#120C14"/>
          <rect x="7" y="12" width="2" height="2" fill={accent}/>
          <rect x="15" y="4" width="2" height="2" fill={accent}/>
        </>
      );
    case 'needle':
      return (
        <>
          ...
          <rect x="10" y="5" width="1" height="8" fill={edge}/>
          <rect x="13" y="5" width="1" height="8" fill={dark}/>
          <rect x="11" y="2" width="2" height="2" fill="#DFFFF0"/>
          <rect x="9" y="7" width="2" height="2" fill={accent}/>
          <rect x="13" y="9" width="2" height="2" fill="#7CFF8A"/>
          <rect x="8" y="12" width="2" height="1" fill="#143B26"/>
          <rect x="14" y="12" width="2" height="1" fill="#143B26"/>
        </>
      );
    case 'club':
      return (
        <>
          ...
          <rect x="10" y="6" width="4" height="6" fill={edge}/>
          <rect x="7" y="7" width="2" height="4" fill={dark}/>
          <rect x="15" y="7" width="2" height="4" fill={dark}/>
          <rect x="10" y="4" width="1" height="9" fill={accent}/>
          <rect x="13" y="5" width="1" height="7" fill="#F0E2B6"/>
        </>
      );
    case 'rake':
      return (
        <>
          <rect x="9" y="5" width="6" height="8" fill={dark}/>
          <rect x="7" y="4" width="2" height="7" fill={metal}/>
          <rect x="10" y="3" width="2" height="9" fill={metal}/>
          <rect x="13" y="4" width="2" height="7" fill={metal}/>
          <rect x="16" y="5" width="2" height="5" fill={metal}/>
          <rect x="8" y="10" width="9" height="2" fill={edge}/>
          <rect x="8" y="12" width="2" height="2" fill={accent}/>
          <rect x="14" y="12" width="2" height="2" fill="#F08A8A"/>
        </>
      );
    case 'axe':
      return (
        <>
          ...
          <rect x="6" y="6" width="6" height="7" fill={metal}/>
          <rect x="12" y="6" width="6" height="7" fill={metal}/>
          <rect x="7" y="7" width="4" height="4" fill={edge}/>
          <rect x="13" y="7" width="4" height="4" fill={edge}/>
          <rect x="11" y="5" width="2" height="9" fill={accent}/>
          <rect x="6" y="13" width="2" height="2" fill="#D7F4FF"/>
    ...
    case 'venomBlade':
      return (
        <>
          <rect x="11" y="3" width="2" height="12" fill={dark}/>
          <rect x="9" y="5" width="3" height="9" fill={metal}/>
          <rect x="12" y="5" width="3" height="9" fill={edge}/>
          <rect x="10" y="4" width="4" height="2" fill="#DFFFF0"/>
          <rect x="8" y="8" width="2" height="2" fill={accent}/>
          <rect x="14" y="11" width="2" height="2" fill="#7CFF8A"/>
          <rect x="9" y="13" width="1" height="2" fill="#143B26"/>
        </>
      );
    case 'flameBlade':
      return (
        <>
          ...
          <rect x="12" y="5" width="3" height="9" fill={edge}/>
          <rect x="10" y="3" width="2" height="4" fill="#FFD166"/>
          <rect x="13" y="4" width="2" height="5" fill="#FF9F1A"/>
          <rect x="8" y="10" width="2" height="3" fill={accent}/>
    ...
    case 'sparkDagger':
      return (
        <>
          <rect x="11" y="3" width="2" height="12" fill={metal}/>
          <rect x="10" y="5" width="1" height="9" fill={edge}/>
          <rect x="13" y="5" width="1" height="9" fill={dark}/>
          <rect x="11" y="2" width="2" height="2" fill="#FFFFFF"/>
          <rect x="7" y="7" width="3" height="1" fill={accent}/>
    ...
    case 'scribeBlade':
      return (
        <>
          ...
          <rect x="15" y="6" width="2" height="8" fill={accent}/>
        </>
      );
    case 'cleaver':
      return (
        <>
          <rect x="8" y="3" width="8" height="12" fill={dark}/>
          <rect x="9" y="4" width="6" height="10" fill={metal}/>
          <rect x="10" y="5" width="4" height="8" fill={edge}/>
          <rect x="13" y="4" width="3" height="4" fill="#F6E1A6"/>
          <rect x="7" y="12" width="2" height="3" fill={dark}/>
          <rect x="9" y="13" width="6" height="1" fill={accent}/>
        </>
      );
    case 'trident':
      return (
    ...
    case 'corrosion':
      return (
        <>
          ...
          <rect x="6" y="7" width="2" height="4" fill={metal}/>
          <rect x="16" y="7" width="2" height="4" fill={metal}/>
          <rect x="9" y="6" width="6" height="6" fill={edge}/>
          <rect x="11" y="8" width="2" height="2" fill="#143B26"/>
          <rect x="8" y="12" width="2" height="2" fill={accent}/>
          <rect x="15" y="5" width="2" height="2" fill="#D9FFD2"/>
        </>
      );
    case 'mace':
      return (
        <>
          ...
          <rect x="9" y="6" width="6" height="6" fill={metal}/>
          <rect x="10" y="7" width="4" height="4" fill={edge}/>
          <rect x="7" y="4" width="2" height="2" fill={metal}/>
          <rect x="15" y="4" width="2" height="2" fill={metal}/>
    ...
    case 'twinHook':
      return (
        <>
          <rect x="7" y="4" width="4" height="10" fill={dark}/>
          <rect x="13" y="4" width="4" height="10" fill={dark}/>
          <rect x="8" y="5" width="2" height="7" fill={metal}/>
          <rect x="14" y="5" width="2" height="7" fill={metal}/>
          <rect x="6" y="7" width="3" height="2" fill={edge}/>
          <rect x="15" y="7" width="3" height="2" fill={edge}/>
          <rect x="9" y="12" width="6" height="2" fill={accent}/>
          <rect x="10" y="14" width="4" height="1" fill="#DFFFFF"/>
        </>
      );
  }
};

const reviewedHeadSprite = (config: ReviewedHeadSpriteConfig): React.FC<{ className?: string }> => {
  return ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderReviewedHeadFrame(config.accent)}
      {renderReviewedHeadMotif(config)}
      {renderReviewedHeadHilt(config)}
      <rect x="18" y="18" width="1" height="1" fill={config.edge}/>
    </svg>
  );
};
...
const reviewedHeadSprites: Record<number, React.FC<{ className?: string }>> = {
  ...
  226: reviewedHeadSprite({ metal: '#8B1E2D', edge: '#F08A8A', dark: '#3A1014', accent: '#D94A4A', hilt: '#5C2A24', motif: 'rake' }),
  227: reviewedHeadSprite({ metal: '#5F7884', edge: '#D7F4FF', dark: '#25343B', accent: '#78D6FF', hilt: '#4A3828', motif: 'axe' }),
  228: reviewedHeadSprite({ metal: '#3D8B4D', edge: '#D9FFD2', dark: '#14331F', accent: '#83F27D', hilt: '#314A28', motif: 'venomBlade' }),
  229: reviewedHeadSprite({ metal: '#B84A24', edge: '#FFE08A', dark: '#3A130E', accent: '#FF9F1A', hilt: '#5A2C1B', motif: 'flameBlade' }),
  230: reviewedHeadSprite({ metal: '#2D6D9B', edge: '#FFFFFF', dark: '#10283F', accent: '#56C8FF', hilt: '#2C3850', motif: 'sparkDagger' }),
  231: reviewedHeadSprite({ metal: '#7E6AA8', edge: '#F4ECFF', dark: '#2D2540', accent: '#BFA3FF', hilt: '#4A3828', motif: 'scribeBlade' }),
  232: reviewedHeadSprite({ metal: '#7A5636', edge: '#F6E1A6', dark: '#2E2118', accent: '#D6B26A', hilt: '#4A2C1C', motif: 'cleaver' }),
  233: reviewedHeadSprite({ metal: '#4E6D82', edge: '#FFFFFF', dark: '#1B2F3B', accent: '#8FE8FF', hilt: '#314A58', motif: 'trident' }),
...
const renderReviewedDecoMotif = (config: ReviewedDecoSpriteConfig) => {
  ...
  switch (config.motif) {
    case 'mirror':
      return (
        <>
          <rect x="7" y="6" width="10" height="12" fill={dark}/>
          <rect x="8" y="7" width="8" height="10" fill={accent}/>
          <rect x="9" y="8" width="6" height="8" fill={base}/>
          <rect x="10" y="9" width="4" height="6" fill={light}/>
          <rect x="11" y="10" width="2" height="4" fill={spark}/>
          <rect x="8" y="5" width="8" height="2" fill="#D6B26A"/>
          <rect x="8" y="17" width="8" height="2" fill="#7A5636"/>
    ...
    case 'bloodWhetstone':
      return (
        <>
          ...
          <rect x="7" y="8" width="10" height="2" fill={base}/>
          <rect x="7" y="16" width="10" height="2" fill="#2A0508"/>
          <rect x="8" y="11" width="8" height="3" fill={light}/>
          <rect x="9" y="12" width="6" height="1" fill={spark}/>
          <rect x="12" y="7" width="2" height="3" fill={accent}/>
          <rect x="15" y="6" width="1" height="4" fill="#F08A8A"/>
          <rect x="7" y="15" width="3" height="2" fill={accent}/>
          <rect x="14" y="14" width="2" height="3" fill="#D94A4A"/>
        </>
      );
    case 'berserkerRune':
      return (
        <>
          <rect x="8" y="7" width="8" height="10" fill={dark}/>
          <rect x="9" y="8" width="6" height="8" fill={base}/>
          <rect x="10" y="9" width="4" height="6" fill="#2A0508"/>
          <rect x="11" y="8" width="2" height="3" fill={accent}/>
          <rect x="10" y="11" width="4" height="2" fill={light}/>
          <rect x="11" y="13" width="2" height="3" fill={spark}/>
          <rect x="7" y="10" width="2" height="4" fill={accent}/>
          <rect x="15" y="10" width="2" height="4" fill={accent}/>
          <rect x="9" y="17" width="6" height="2" fill="#3A1014"/>
        </>
      );
    case 'shieldShard':
      return (
    ...
    case 'steelPlating':
      return (
        <>
          <rect x="6" y="8" width="12" height="9" fill={dark}/>
          <rect x="7" y="9" width="10" height="7" fill={base}/>
          <rect x="8" y="10" width="8" height="2" fill={light}/>
          <rect x="8" y="14" width="8" height="2" fill="#4A5058"/>
          <rect x="10" y="6" width="4" height="3" fill={dark}/>
          <rect x="11" y="7" width="2" height="2" fill={accent}/>
          <rect x="5" y="11" width="2" height="4" fill={light}/>
          <rect x="17" y="11" width="2" height="4" fill={light}/>
          <rect x="11" y="10" width="2" height="6" fill={spark}/>
        </>
      );
    case 'poisonPouch':
      return (
    ...
    case 'bloodstoneRune':
      return (
        <>
          ...
          <rect x="9" y="8" width="6" height="8" fill={base}/>
          <rect x="10" y="9" width="4" height="6" fill="#2A0508"/>
          <rect x="11" y="7" width="2" height="10" fill={accent}/>
          <rect x="9" y="11" width="6" height="2" fill={light}/>
          <rect x="7" y="9" width="2" height="2" fill={accent}/>
          <rect x="15" y="14" width="2" height="2" fill="#F08A8A"/>
          <rect x="10" y="17" width="4" height="2" fill={dark}/>
          <rect x="12" y="10" width="1" height="4" fill={spark}/>
        </>
      );
    case 'bulwarkLens':
      return (
        <>
          <rect x="7" y="7" width="10" height="10" fill={dark}/>
          <rect x="8" y="8" width="8" height="8" fill={base}/>
          <rect x="9" y="9" width="6" height="6" fill={light}/>
          <rect x="10" y="10" width="4" height="4" fill="#25343B"/>
          <rect x="11" y="11" width="2" height="2" fill={spark}/>
          <rect x="6" y="11" width="12" height="2" fill={accent}/>
          <rect x="11" y="6" width="2" height="12" fill={accent}/>
          <rect x="8" y="17" width="3" height="2" fill={dark}/>
          <rect x="14" y="17" width="2" height="2" fill={light}/>
        </>
      );
    case 'venomLens':
      return (
        <>
          ...
          <rect x="8" y="8" width="8" height="8" fill={base}/>
          <rect x="9" y="9" width="6" height="6" fill={light}/>
          <rect x="10" y="10" width="4" height="4" fill="#14331F"/>
          <rect x="11" y="11" width="2" height="2" fill={spark}/>
          <rect x="6" y="9" width="2" height="2" fill={accent}/>
          <rect x="16" y="14" width="2" height="2" fill={accent}/>
          <rect x="9" y="17" width="2" height="2" fill={light}/>
          <rect x="15" y="6" width="2" height="2" fill={spark}/>
        </>
      );
    case 'flameLens':
      return (
        <>
          <rect x="7" y="7" width="10" height="10" fill={dark}/>
          <rect x="8" y="8" width="8" height="8" fill={base}/>
          <rect x="9" y="9" width="6" height="6" fill={accent}/>
          <rect x="10" y="10" width="4" height="4" fill="#3A130E"/>
          <rect x="11" y="11" width="2" height="3" fill={spark}/>
          <rect x="10" y="7" width="2" height="4" fill="#FFE08A"/>
          <rect x="14" y="8" width="2" height="5" fill="#FF7A1A"/>
          <rect x="7" y="16" width="3" height="2" fill={accent}/>
          <rect x="16" y="15" width="1" height="2" fill="#FFE08A"/>
        </>
      );
    case 'overchargeCoil':
      return (
        <>
          ...
          <rect x="7" y="14" width="10" height="2" fill={dark}/>
          <rect x="9" y="17" width="6" height="2" fill={base}/>
          <rect x="11" y="6" width="2" height="13" fill={spark}/>
          <rect x="10" y="8" width="4" height="1" fill={light}/>
          <rect x="9" y="12" width="6" height="1" fill="#AEEBFF"/>
          <rect x="10" y="15" width="4" height="1" fill="#143B8F"/>
          <rect x="6" y="10" width="3" height="1" fill={accent}/>
          <rect x="15" y="12" width="3" height="1" fill={accent}/>
          <rect x="6" y="16" width="3" height="1" fill="#FFE66D"/>
          <rect x="16" y="7" width="2" height="2" fill="#FFFFFF"/>
          <rect x="17" y="17" width="1" height="2" fill="#E8F7FF"/>
        </>
      );
    case 'flowFeather':
      return (
        <>
          <rect x="11" y="5" width="2" height="13" fill={dark}/>
          <rect x="8" y="7" width="3" height="3" fill={light}/>
          <rect x="7" y="10" width="4" height="2" fill={base}/>
          <rect x="6" y="13" width="5" height="2" fill={light}/>
          <rect x="13" y="7" width="3" height="3" fill={base}/>
          <rect x="13" y="11" width="4" height="2" fill={light}/>
          <rect x="13" y="15" width="3" height="2" fill={base}/>
          <rect x="8" y="16" width="3" height="2" fill={accent}/>
          <rect x="15" y="6" width="2" height="2" fill={spark}/>
        </>
      );
    case 'growthCrest':
      return (
        <>
          <rect x="7" y="8" width="10" height="8" fill={dark}/>
          <rect x="8" y="9" width="8" height="6" fill={base}/>
          <rect x="9" y="10" width="6" height="4" fill={light}/>
          <rect x="11" y="5" width="2" height="4" fill={accent}/>
          <rect x="9" y="6" width="2" height="3" fill={base}/>
          <rect x="13" y="6" width="2" height="3" fill={base}/>
          <rect x="10" y="12" width="4" height="3" fill="#2E2118"/>
          <rect x="7" y="16" width="4" height="2" fill={accent}/>
          <rect x="14" y="15" width="3" height="3" fill={spark}/>
        </>
      );
    case 'resonanceStone':
      return (
        <>
          ...
          <rect x="11" y="10" width="2" height="4" fill={spark}/>
          <rect x="6" y="9" width="2" height="2" fill={accent}/>
          <rect x="16" y="9" width="2" height="2" fill={accent}/>
          <rect x="5" y="13" width="2" height="1" fill="#FFFFFF"/>
          <rect x="17" y="13" width="2" height="1" fill="#FFFFFF"/>
          <rect x="8" y="17" width="3" height="2" fill={accent}/>
          <rect x="14" y="17" width="2" height="2" fill={spark}/>
        </>
      );
  }
};
...
const reviewedDecoSprites: Record<number, React.FC<{ className?: string }>> = {
  ...
  305: reviewedDecoSprite({ base: '#87CEEB', light: '#E8F7FF', dark: '#1B2F3B', accent: '#D6B26A', spark: '#FFFFFF', motif: 'mirror' }),
  311: reviewedDecoSprite({ base: '#6B6F75', light: '#D8E0E6', dark: '#30343A', accent: '#78D6FF', spark: '#FFFFFF', motif: 'steelPlating' }),
  319: reviewedDecoSprite({ base: '#8B1E2D', light: '#F08A8A', dark: '#3A1014', accent: '#D94A4A', spark: '#FFD0D0', motif: 'bloodWhetstone' }),
  320: reviewedDecoSprite({ base: '#8B1E2D', light: '#FF6A1A', dark: '#2A0508', accent: '#D94A4A', spark: '#FFE08A', motif: 'berserkerRune' }),
  337: reviewedDecoSprite({ base: '#8B1E2D', light: '#F08A8A', dark: '#2A0508', accent: '#D94A4A', spark: '#FFD0D0', motif: 'bloodstoneRune' }),
  338: reviewedDecoSprite({ base: '#557080', light: '#D7F4FF', dark: '#25343B', accent: '#78D6FF', spark: '#FFFFFF', motif: 'bulwarkLens' }),
  339: reviewedDecoSprite({ base: '#3D8B4D', light: '#83F27D', dark: '#14331F', accent: '#B8FF7A', spark: '#D9FFD2', motif: 'venomLens' }),
  340: reviewedDecoSprite({ base: '#A8441C', light: '#FF9F1A', dark: '#3A130E', accent: '#FFD166', spark: '#FFE08A', motif: 'flameLens' }),
  341: reviewedDecoSprite({ base: '#2D6D9B', light: '#56C8FF', dark: '#10283F', accent: '#FFE66D', spark: '#FFFFFF', motif: 'overchargeCoil' }),
  342: reviewedDecoSprite({ base: '#D8C49C', light: '#F4ECFF', dark: '#2D2540', accent: '#BFA3FF', spark: '#FFFFFF', motif: 'flowFeather' }),
  343: reviewedDecoSprite({ base: '#7A5636', light: '#F6E1A6', dark: '#2E2118', accent: '#D6B26A', spark: '#FFF1B0', motif: 'growthCrest' }),
  344: reviewedDecoSprite({ base: '#4E6D82', light: '#8FE8FF', dark: '#1B2F3B', accent: '#D49CFF', spark: '#FFFFFF', motif: 'resonanceStone' })
};
...
const earlyRunCardSprites: Record<number, React.FC<{ className?: string }>> = {
  101: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      <rect x="8" y="20" width="8" height="1" fill="#09070D" opacity="0.4"/>
      <rect x="9" y="4" width="6" height="16" fill="#2B1A10"/>
      <rect x="10" y="5" width="4" height="14" fill="#8B5A2B"/>
      <rect x="11" y="5" width="2" height="14" fill="#C48745"/>
      <rect x="8" y="6" width="8" height="2" fill="#5A3822"/>
      <rect x="8" y="16" width="8" height="2" fill="#5A3822"/>
      <rect x="9" y="9" width="6" height="2" fill="#3A2418"/>
      <rect x="9" y="13" width="6" height="2" fill="#3A2418"/>
      <rect x="10" y="19" width="4" height="2" fill="#1B100A"/>
    </svg>
  ),
  102: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      ...
      <rect x="5" y="9" width="6" height="7" fill="#25343B"/>
      <rect x="13" y="9" width="6" height="7" fill="#25343B"/>
      <rect x="6" y="10" width="4" height="5" fill="#6F8A98"/>
      <rect x="14" y="10" width="4" height="5" fill="#6F8A98"/>
  ...
  103: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      ...
      <rect x="10" y="5" width="2" height="10" fill="#C9D1D6"/>
      <rect x="12" y="5" width="2" height="10" fill="#7B858C"/>
      <rect x="11" y="2" width="2" height="2" fill="#E3E7EA"/>
      <rect x="9" y="8" width="2" height="2" fill="#8B4513"/>
      <rect x="13" y="12" width="2" height="2" fill="#8B4513"/>
  ...
  104: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      <rect x="6" y="19" width="12" height="1" fill="#09070D" opacity="0.4"/>
      <rect x="5" y="13" width="14" height="5" fill="#2F3941"/>
      <rect x="6" y="11" width="12" height="4" fill="#7F8D96"/>
      <rect x="8" y="9" width="8" height="3" fill="#B8C4CA"/>
      <rect x="10" y="7" width="4" height="2" fill="#DCE4E8"/>
      <rect x="10" y="5" width="4" height="2" fill="#53606A"/>
      <rect x="8" y="14" width="8" height="2" fill="#DCE4E8"/>
      <rect x="17" y="13" width="2" height="4" fill="#53606A"/>
      <rect x="5" y="15" width="2" height="2" fill="#53606A"/>
    </svg>
  ),
  105: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      <rect x="6" y="18" width="12" height="1" fill="#09070D" opacity="0.4"/>
      <rect x="6" y="9" width="12" height="8" fill="#30343A"/>
      <rect x="7" y="8" width="10" height="2" fill="#6B7278"/>
      <rect x="7" y="11" width="10" height="4" fill="#A8B0B6"/>
      <rect x="8" y="12" width="7" height="1" fill="#E1E6E8"/>
      <rect x="7" y="16" width="10" height="2" fill="#4B5258"/>
      <rect x="5" y="11" width="2" height="4" fill="#4B5258"/>
      <rect x="17" y="12" width="2" height="3" fill="#202428"/>
      <rect x="11" y="14" width="5" height="1" fill="#6B7278"/>
    </svg>
  ),
  106: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderEarlyRunFrame("#E8D9A8")}
      <rect x="7" y="8" width="10" height="2" fill="#5C4426"/>
      <rect x="6" y="10" width="3" height="6" fill="#5C4426"/>
      <rect x="15" y="10" width="3" height="6" fill="#5C4426"/>
      <rect x="8" y="16" width="8" height="2" fill="#5C4426"/>
      <rect x="8" y="9" width="8" height="2" fill="#CBAE74"/>
      <rect x="9" y="11" width="2" height="5" fill="#FFF4CC"/>
      <rect x="13" y="11" width="2" height="5" fill="#CBAE74"/>
      <rect x="10" y="17" width="4" height="1" fill="#2E2118"/>
    </svg>
  ),
  201: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderEarlyRunFrame("#AEEBFF")}
      <rect x="10" y="5" width="4" height="14" fill="#10283F"/>
      <rect x="9" y="7" width="6" height="10" fill="#2F4F4F"/>
      <rect x="11" y="6" width="2" height="12" fill="#7DAFC2"/>
      <rect x="11" y="4" width="2" height="2" fill="#AEEBFF"/>
      <rect x="8" y="9" width="8" height="2" fill="#C0C0C0"/>
      <rect x="8" y="14" width="8" height="2" fill="#1B2F3B"/>
      <rect x="10" y="18" width="4" height="2" fill="#0B1824"/>
    </svg>
  ),
  202: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
  ...
  203: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      ...
      <rect x="8" y="5" width="8" height="9" fill="#30343A"/>
      <rect x="9" y="6" width="6" height="7" fill="#8A939B"/>
      <rect x="6" y="6" width="3" height="2" fill="#D8E0E6"/>
      <rect x="15" y="7" width="3" height="2" fill="#D8E0E6"/>
      <rect x="6" y="11" width="3" height="2" fill="#D8E0E6"/>
      <rect x="15" y="12" width="3" height="2" fill="#D8E0E6"/>
      <rect x="8" y="14" width="8" height="2" fill="#50555C"/>
      <rect x="10" y="16" width="4" height="4" fill="#3A2418"/>
    </svg>
  ),
  204: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      ...
      <rect x="8" y="6" width="3" height="4" fill="#FFFFFF"/>
      <rect x="7" y="10" width="4" height="3" fill="#E8E8E8"/>
      <rect x="6" y="13" width="5" height="3" fill="#D8C49C"/>
      <rect x="13" y="7" width="3" height="4" fill="#F4ECFF"/>
      <rect x="13" y="11" width="4" height="3" fill="#C8B8E8"/>
      <rect x="13" y="14" width="3" height="3" fill="#BFA3FF"/>
    </svg>
  ),
  205: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderEarlyRunFrame("#83F27D")}
      <rect x="7" y="8" width="10" height="10" fill="#14331F"/>
      <rect x="8" y="9" width="8" height="7" fill="#2E8B57"/>
      <rect x="9" y="10" width="6" height="4" fill="#90EE90"/>
      <rect x="7" y="6" width="10" height="2" fill="#5C4426"/>
      <rect x="6" y="12" width="2" height="3" fill="#3CB371"/>
      <rect x="16" y="12" width="2" height="3" fill="#3CB371"/>
      <rect x="11" y="11" width="2" height="2" fill="#006400"/>
    </svg>
  ),
  206: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      ...
      <rect x="10" y="5" width="4" height="14" fill="#6B5A45"/>
      <rect x="9" y="7" width="6" height="10" fill="#D8D8CC"/>
      <rect x="11" y="6" width="2" height="12" fill="#FFF7D6"/>
      ...
      <rect x="10" y="18" width="4" height="2" fill="#3A2418"/>
    </svg>
  ),
  207: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderEarlyRunFrame("#DCE6F0")}
      <rect x="7" y="9" width="10" height="8" fill="#30343A"/>
      <rect x="8" y="10" width="8" height="6" fill="#708090"/>
      <rect x="9" y="11" width="6" height="3" fill="#B0BEC5"/>
      <rect x="11" y="5" width="2" height="4" fill="#DCE6F0"/>
      <rect x="4" y="12" width="4" height="2" fill="#DCE6F0"/>
      <rect x="16" y="12" width="4" height="2" fill="#DCE6F0"/>
      <rect x="11" y="17" width="2" height="4" fill="#C0C9D2"/>
      <rect x="10" y="15" width="4" height="2" fill="#78D6FF"/>
    </svg>
  ),
  208: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
      {renderEarlyRunFrame("#56C8FF")}
      <rect x="8" y="8" width="8" height="9" fill="#10283F"/>
      <rect x="9" y="7" width="6" height="11" fill="#4169E1"/>
      <rect x="10" y="9" width="4" height="7" fill="#6495ED"/>
      <rect x="11" y="10" width="2" height="4" fill="#87CEEB"/>
      <rect x="10" y="5" width="4" height="2" fill="#AEEBFF"/>
      <rect x="10" y="18" width="4" height="1" fill="#143B8F"/>
      <rect x="15" y="10" width="2" height="4" fill="#FFE66D"/>
    </svg>
  ),
  215: ({ className }) => (
    <svg viewBox="0 0 24 24" className={className} style={{ imageRendering: 'pixelated' }}>
