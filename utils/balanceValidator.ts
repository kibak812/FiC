...
Object.assign(CARD_EFFECT_MAPPING, {
  216: { effects: ['DAMAGE_MULT', 'SELF_DAMAGE'], values: { multiplier: 1, selfDamage: 2 } },
  217: { effects: ['DAMAGE_MULT', 'BLOCK'], values: { multiplier: 1, block: 6 } },
  220: { effects: ['DAMAGE_MULT', 'STATUS_APPLY'], values: { multiplier: 1, poison: 2 } },
  221: { effects: ['DAMAGE_MULT', 'STATUS_APPLY'], values: { multiplier: 1, burn: 2 } },
  222: { effects: ['DAMAGE_MULT', 'ENERGY_GAIN'], values: { multiplier: 1, energy: 1 } },
  223: { effects: ['DAMAGE_MULT', 'DRAW_CARD'], values: { multiplier: 1, draw: 1 } },
  224: { effects: ['DAMAGE_MULT'], values: { multiplier: 1.5, heavy: true } },
  225: { effects: ['DAMAGE_MULT', 'MULTI_HIT'], values: { multiplier: 0.6, hits: 2, effectDouble: true } },
  226: { effects: ['DIRECT_DAMAGE', 'SELF_DAMAGE'], values: { damage: 7, selfDamage: 2 } },
  227: { effects: ['BLOCK'], values: { block: 6 } },
  228: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 4, poison: 3 } },
  229: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 5, burn: 2 } },
  230: { effects: ['DIRECT_DAMAGE', 'ENERGY_GAIN'], values: { damage: 4, energy: 1 } },
  231: { effects: ['DIRECT_DAMAGE', 'DRAW_CARD'], values: { damage: 5, draw: 1 } },
  232: { effects: ['DIRECT_DAMAGE'], values: { damage: 14, heavy: true } },
  233: { effects: ['DIRECT_DAMAGE', 'MULTI_HIT'], values: { damage: 2, hits: 3 } },
  234: { effects: ['DIRECT_DAMAGE', 'DAMAGE_ADD'], values: { damage: 4, comboScaling: true } },
  235: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 3, poisonScaling: true } },
  236: { effects: ['DAMAGE_ADD', 'SELF_DAMAGE'], values: { bonus: 2, selfDamage: 2 } },
  237: { effects: ['BLOCK_CONVERT'], values: { percent: 0.4 } },
  238: { effects: ['STATUS_APPLY'], values: { poison: 2 } },
  239: { effects: ['STATUS_APPLY'], values: { burn: 2 } },
  240: { effects: ['ENERGY_GAIN'], values: { energy: 1 } },
  241: { effects: ['NEXT_TURN_DRAW'], values: { draw: 1 } },
  242: { effects: ['DAMAGE_ADD'], values: { bonus: 5, heavy: true } },
  243: { effects: ['DAMAGE_ADD'], values: { bonus: 1, multiHitBonus: 4 } },
  244: { effects: ['STATUS_APPLY'], values: { weak: 1 } },
  ...
  324: { effects: ['DAMAGE_MULT', 'STATUS_APPLY'], values: { multiplier: 1, burn: 3 } },
  325: { effects: ['DAMAGE_MULT', 'ENERGY_GAIN'], values: { multiplier: 1, energy: 1 } },
  326: { effects: ['DAMAGE_MULT', 'DRAW_CARD'], values: { multiplier: 1, draw: 1 } },
  327: { effects: ['DAMAGE_MULT'], values: { multiplier: 2.2, heavy: true } },
  328: { effects: ['DAMAGE_MULT', 'MULTI_HIT'], values: { multiplier: 1.2, hits: 2, effectDouble: true } },
  329: { effects: ['DIRECT_DAMAGE', 'SELF_DAMAGE'], values: { damage: 10, selfDamage: 4 } },
  330: { effects: ['BLOCK'], values: { block: 12 } },
  331: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 8, poison: 5 } },
  332: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 9, burn: 5 } },
  333: { effects: ['DIRECT_DAMAGE', 'ENERGY_GAIN'], values: { damage: 6, energy: 1 } },
  334: { effects: ['DIRECT_DAMAGE', 'DRAW_CARD'], values: { damage: 5, draw: 1 } },
  335: { effects: ['DIRECT_DAMAGE', 'MULTI_HIT'], values: { damage: 5, hits: 3 } },
  336: { effects: ['DIRECT_DAMAGE'], values: { damage: 24, heavy: true } },
  337: { effects: ['DAMAGE_ADD', 'SELF_DAMAGE'], values: { selfDamageBonus: true, selfDamage: 3 } },
  338: { effects: ['BLOCK', 'BLOCK_CONVERT'], values: { blockMultiplier: 2, percent: 1 } },
  339: { effects: ['STATUS_APPLY'], values: { poison: 5 } },
  340: { effects: ['STATUS_APPLY'], values: { burn: 4 } },
  341: { effects: ['ENERGY_GAIN'], values: { energy: 1 } },
  342: { effects: ['DRAW_CARD'], values: { draw: 1 } },
  343: { effects: ['DAMAGE_MULT'], values: { multiplier: 1.5 } },
  344: { effects: ['DAMAGE_ADD'], values: { multiHitBonus: 6 } },
  414: { effects: ['DAMAGE_MULT', 'SELF_DAMAGE'], values: { multiplier: 1.8, selfDamage: 8 } },
  415: { effects: ['DAMAGE_MULT', 'BLOCK'], values: { multiplier: 2, block: 25 } },
  416: { effects: ['DAMAGE_MULT', 'DRAW_CARD'], values: { multiplier: 1, draw: 1, returnToHand: true } },
  417: { effects: ['DAMAGE_MULT', 'MULTI_HIT'], values: { multiplier: 1.5, hits: 2, effectDouble: true } },
  418: { effects: ['DIRECT_DAMAGE', 'SELF_DAMAGE'], values: { damage: 24, selfDamage: 8 } },
  419: { effects: ['BLOCK'], values: { block: 25 } },
  420: { effects: ['DIRECT_DAMAGE', 'STATUS_APPLY'], values: { damage: 12, poison: 8, burn: 6 } },
  421: { effects: ['DIRECT_DAMAGE', 'MULTI_HIT', 'EXHAUST'], values: { damage: 8, hits: 4 } },
  422: { effects: ['DAMAGE_ADD', 'SELF_DAMAGE'], values: { selfDamageBonus: true, selfDamage: 4, multiplier: 2 } },
  423: { effects: ['BLOCK', 'BLOCK_CONVERT'], values: { blockMultiplier: 2, percent: 1.5 } },
  424: { effects: ['ENERGY_GAIN'], values: { energy: 2 } },
  425: { effects: ['DRAW_CARD', 'NEXT_TURN_DRAW'], values: { draw: 2, nextDraw: 1 } },
